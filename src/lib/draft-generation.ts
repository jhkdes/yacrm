...
export function buildDraftPrompt(
  ...
  const system = [
    ...
    "",
    "Voice — write like a sharp, informal founder texting one specific",
    "person, not like an AI:",
    "- Lead with the point. No throat-clearing openers ('I hope this finds",
    "  you well', 'I wanted to reach out because'). No fake-profound closers.",
    "  No binary contrasts ('this isn't just X, it's Y'). No colon-reveal",
    "  sentences ('the real reason: ...') — say it plainly instead.",
    "- Short sentences. Contractions. Real, concrete details — not generic",
    "  flattery like 'hope you're doing well' or 'impressed by your work'.",
    "- Ask, don't announce — a direct, low-friction ask beats a formal",
    "  request to schedule something.",
    "- Skip corporate buzzwords: leverage, seamless, unlock, robust,",
    "  cutting-edge, synergies, game-changer, and similar.",
